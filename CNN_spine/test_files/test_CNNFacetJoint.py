...
test_dir = "/media/maryviktory/My Passport/IPCAI 2020 TUM/Facet_Db/test_facet_non_facet"
...
def main():
    ...
    gap_list = os.listdir(os.path.join(test_dir, "Facet"))
    non_gap_list = os.listdir(os.path.join(test_dir, "NonFacet"))

    gap_list = [os.path.join(test_dir, "Facet", item) for item in gap_list]
    non_gap_list = [os.path.join(test_dir, "NonFacet", item) for item in non_gap_list]
