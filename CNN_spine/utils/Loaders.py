...
class OfflineLoader(StreamLoader):
    ...
    def _init_(self, sweep_path, sweep_label_path=None, sort_type = 1, bias = 0):
        super.__init__(sweep_path, sweep_label_path, sort_type, bias)
