...
if __name__ == '__main__':
    ...
    if Polyaxon_flag == "True":
        ...
        data_dir = "/media/maryviktory/My Passport/IROS 2020 TUM/DATASETs/Dataset/DATA_toNas_for CNN_IPCAI/small_subset/"
        outputs_path = '/media/maryviktory/My Passport/IROS 2020 TUM/DATASETs/Dataset/DATA_toNas_for CNN_IPCAI/output/'
        logger = logging.getLogger()
        logger.setLevel(logging.INFO)
        logger.addHandler(logging.FileHandler(os.path.join(outputs_path, 'SpinousProcess.log')))
...
#######3 Chhose model
    ...
    # Train and evaluate
    model_ft,model_save_path= train_model(model_ft, criterion, optimizer_ft, exp_lr_scheduler, outputs_path, num_epochs, model_name,feature_extract, use_pretrained,dataset)
