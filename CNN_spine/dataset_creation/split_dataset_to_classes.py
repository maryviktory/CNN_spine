...
parser.add_argument('-d', '--dir', default="/media/maryviktory/My Passport/spine navigation Polyu 2021/DATASET_polyu/PWH_sweeps/Subjects dataset/new", help='Database directory')
