...
if __name__ == '__main__':
    ...
    parser.add_argument('--flag_Polyaxon', type= bool, default=True,
    ...
    parser.add_argument('--network', default='vgg', type=str, metavar='N',
    ...
    if Polyaxon_flag == True:
        ...
        outputs_path = '/media/maryviktory/My Passport/IPCAI 2020 TUM/DATA_toNas_for CNN_IPCAI/output/'
        logger = logging.getLogger()
        logger.setLevel(logging.INFO)
        logger.addHandler(logging.FileHandler(os.path.join(outputs_path, 'SpinousProcess.log')))
